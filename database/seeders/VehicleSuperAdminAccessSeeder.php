...
class VehicleSuperAdminAccessSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // 2. Define the permissions needed for Vehicle Management
        $resources = [
            'Vehicle', 
            'VehicleAssignment', 
        ...
        $this->command->info('VehicleSuperAdminAccessSeeder completed successfully.');
    }
}
