...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        body{font-family:'Inter',sans-serif;background:#003366;min-height:100vh;display:flex;align-items:center;justify-content:center;}
        .auth-wrap{width:100%;max-width:460px;padding:1.5rem;}
        .auth-logo{text-align:center;margin-bottom:2rem;}
        .auth-logo-mark{width:56px;height:56px;background:#00A3E0;border-radius:14px;display:inline-flex;align-items:center;justify-content:center;font-weight:800;font-size:1.4rem;color:#fff;margin-bottom:.75rem;}
        ...
        .auth-card h2{font-size:1.25rem;font-weight:700;color:#003366;margin-bottom:.35rem;}
        .auth-card .subtitle{font-size:.875rem;color:#6b7a90;margin-bottom:1.75rem;}
        .form-group{margin-bottom:1.25rem;}
        .form-group label{display:block;font-size:.75rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#003366;margin-bottom:.4rem;}
        ...
        .form-group input:focus{outline:none;border-color:#00A3E0;box-shadow:0 0 0 3px rgba(0,163,224,.15);}
        .form-group input.err{border-color:#c0392b;}
        .err-msg{font-size:.78rem;color:#c0392b;margin-top:.3rem;}
        .forgot{font-size:.8rem;color:#00A3E0;text-decoration:none;float:right;margin-top:-.8rem;margin-bottom:1rem;display:block;text-align:right;}
        .forgot:hover{text-decoration:underline;}
        .btn-primary{width:100%;padding:.75rem;background:#00A3E0;color:#fff;border:none;border-radius:8px;font-family:inherit;font-size:1rem;font-weight:700;cursor:pointer;transition:background .15s;margin-top:.5rem;}
        .btn-primary:hover{background:#0088c7;}
        .auth-footer{text-align:center;margin-top:1.5rem;font-size:.875rem;color:#6b7a90;}
        .auth-footer a{color:#00A3E0;text-decoration:none;font-weight:600;}
        ...
        .remember-row input{accent-color:#00A3E0;width:15px;height:15px;}
...
<div class="auth-wrap">
    <div class="auth-logo">
        <div class="auth-logo-mark">EP</div>
        <h1>Supplier Portal</h1>
        <p>EliSOFT ERP — Procurement System</p>
    </div>
