...
<div class="wrap">
  <div class="header">
    ...
    <h1>Recruitment Plan Approved</h1>
  </div>
  <div class="strip"></div>
  <div class="body">
    <div class="congrats">✅</div>
    <div class="status-badge">✓ Approved</div>
    <p>Your recruitment plan has been <strong>approved</strong>. You can now proceed to create and publish job postings for this position.</p>
    ...
    <div class="detail-box">
      ...
      <div class="detail-row">
        ...
        <span class="detail-value">{{ $plan->approver?->name ?? '—' }}</span>
      </div>
      <div class="detail-row">
        <span class="detail-label">Approved On:</span>
        <span class="detail-value">{{ $plan->approved_at?->format('d F Y, H:i') ?? '—' }}</span>
      </div>
    </div>
    ...
    <div class="next-steps">
      <h3>Next Steps</h3>
      <ul>
        <li>Navigate to <strong>Recruitment → Job Postings</strong> to create a posting for this position.</li>
        <li>Ensure the job position description and requirements are fully detailed before publishing.</li>
      </ul>
    </div>

    @if(!empty($viewUrl))
    <div style="text-align:center;margin:24px 0 16px;">
      <a href="{{ $viewUrl }}" style="display:inline-block;background:#16a34a;color:#fff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:8px;text-decoration:none;letter-spacing:.02em;">View Approved Plan →</a>
    </div>
    @endif
  </div>
  <div class="footer">
