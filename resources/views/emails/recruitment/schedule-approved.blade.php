...
<div class="wrap">
  <div class="header">
    ...
    <h1>Interview Schedule Approved</h1>
  </div>
  <div class="strip"></div>
  <div class="body">
    <div class="congrats">✅</div>
    <div class="status-badge">✓ Approved</div>
    <p>Your interview schedule has been <strong>approved</strong>. Invitations have been sent to candidates and interviewers.</p>
    ...
    <div style="text-align:center;margin:24px 0 16px;">
      <a href="{{ $viewUrl }}" style="display:inline-block;background:#16a34a;color:#fff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:8px;text-decoration:none;letter-spacing:.02em;">View Approved Schedule →</a>
    </div>
    @endif
  </div>
  <div class="footer">
