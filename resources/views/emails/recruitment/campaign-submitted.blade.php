...
<div class="wrap">
  <div class="header">
    ...
    <h1>Recruitment Campaign Awaiting Your Approval</h1>
  </div>
  <div class="strip"></div>
  <div class="body">
    <div class="status-badge">⏳ Pending Approval</div>
    <p>A recruitment campaign has been submitted and requires your review and approval.</p>
    ...
    <div class="detail-box">
      ...
      <div class="detail-row">
        ...
        <span class="detail-value">{{ $campaign->creator->name ?? '—' }}</span>
      </div>
      <div class="detail-row">
    ...
    <div class="next-steps">
      ...
      <ul>
        <li>Please review the campaign details carefully.</li>
        <li>Approve the campaign to make it active, or return it with notes for revision.</li>
      </ul>
    </div>

    @if(!empty($viewUrl))
    <div style="text-align:center;margin:32px 0 16px;">
      <a href="{{ $viewUrl }}" style="display:inline-block;background:#003366;color:#fff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:8px;text-decoration:none;letter-spacing:.02em;">Review Campaign →</a>
    </div>
    @endif
