...
<div class="wrap">
  <div class="header">
    ...
    <h1>Recruitment Campaign — Returned for Revision</h1>
  </div>
  <div class="strip"></div>
  <div class="body">
    <div class="status-badge">✗ Returned</div>
    <p>Your recruitment campaign has been <strong>returned for revision</strong>. Please review the feedback below and re-submit after making the requested changes.</p>
    ...
    <div class="next-steps">
      <h3>What To Do</h3>
      <ul>
        <li>Open the recruitment campaign in the ERP.</li>
        <li>Address the feedback above.</li>
        <li>Re-submit the campaign for approval.</li>
      </ul>
    </div>

    @if(!empty($viewUrl))
    <div style="text-align:center;margin:24px 0 16px;">
      <a href="{{ $viewUrl }}" style="display:inline-block;background:#dc2626;color:#fff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:8px;text-decoration:none;letter-spacing:.02em;">Edit Campaign →</a>
    </div>
    @endif
  </div>
  <div class="footer">
