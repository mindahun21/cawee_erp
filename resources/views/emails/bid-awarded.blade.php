...
<style>
  ...
  .strip{height:5px;background:#6C5CE7;}
  ...
  .cta{display:inline-block;background:#362A72;color:#fff;padding:14px 32px;border-radius:8px;text-decoration:none;font-weight:700;font-size:15px;margin-top:8px;}
...
<div class="wrap">
  <div class="header">
    <div class="header-logo">Cawee ERP — Procurement</div>
  ...
  <div class="body">
    ...
    <p style="margin-top:32px;font-size:14px;color:#6b7a90;">
      ...
      <a href="mailto:procurement@company.com" style="color:#6C5CE7;">procurement@company.com</a>.
    </p>
  </div>
  <div class="footer">
    This email was sent by Cawee ERP Procurement System. &copy; {{ date('Y') }} All rights reserved.
  </div>
</div>
</body>
</html>
