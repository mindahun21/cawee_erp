...
namespace App\Filament\Resources\VehicleManagement\BranchUtilities;
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('utility_type_option_id')
                ->label('Utility Type')
                ->options(VehicleSetting::optionsFor('utility_type'))
                ->searchable()
                ->required(),
            ...
            Select::make('payment_cycle_option_id')
                ->label('Payment Cycle')
                ->options(VehicleSetting::optionsFor('utility_payment_cycle'))
                ->nullable(),
