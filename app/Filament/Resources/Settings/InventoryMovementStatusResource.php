...
class InventoryMovementStatusResource extends Resource
{
    protected static ?string $model = InventoryMovementStatus::class;
    ...
    {
        return [
            'index' => \App\Filament\Resources\Settings\InventoryMovementStatusResource\Pages\ManageInventoryMovementStatuses::route('/'),
        ];
    }
}
