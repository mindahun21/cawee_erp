...
use App\Filament\Resources\Settings\MaintenanceTypeResource\Pages\ManageMaintenanceTypes;
...
class MaintenanceTypeResource extends Resource
{
    ...
    protected static ?string $slug = 'maintenance-types';
    ...
    {
        return [
            'index' => ManageMaintenanceTypes::route('/'),
        ];
    }
}
