                ...
                Grid::make(2)->schema([
                    ...
                    Select::make('status')
                        ->options([
                            ...
                            RecruitmentApplication::STATUS_INTERVIEWED         => 'Interviewed',
                            RecruitmentApplication::STATUS_WAITLISTED          => 'Waitlisted',
                            RecruitmentApplication::STATUS_SELECTED            => 'Selected',
